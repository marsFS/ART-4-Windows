            ...
            IF MB%=4 THEN
              ...
              IF TY%=0 THEN
                CASE TX% OF
                  ...
                  WHEN 17: dither%=(dither%+1) MOD 5:toolsel%=2:toolcursor%=16 : REM dither scale
                  ...
                  WHEN 36: REM frame%
                  WHEN 37: PROCmenurestore:PROCloadnextframe(-1,1) : REM save current frame and display previous frame in sequence
                ...
                CASE TY% OF
                  WHEN 1 : REM shape selector
                    CASE TX% OF
                      ...
                      WHEN 4: animateshape%=(animateshape%+1) AND 1 : REM animated shape toggle
